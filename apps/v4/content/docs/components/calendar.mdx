...
```bash
npx shadcn@latest add https://minecraft.ani.ink/r/styles/minecraft/calendar.json
```
...
```bash
npx shadcn@latest add https://minecraft.ani.ink/r/styles/minecraft/calendar-02.json
```
