...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-muted-foreground bg-background flex w-fit items-center justify-between gap-2 border-2 border-[var(--mc-border)] bg-transparent px-3 py-2 font-sans text-sm whitespace-nowrap shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.3)] outline-none focus-visible:border-[var(--mc-stone-dark)] disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-9 data-[size=sm]:h-8 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
